...
import com.smarthome.assistant.entity.Result;
...
public class VoiceController {
    ...
    public Result voiceToText(@RequestParam("audio") MultipartFile audioFile) throws IOException {
        log.info("接收到语音转文本请求，文件名: {}, 大小: {} bytes",
                audioFile.getOriginalFilename(), audioFile.getSize());

        String s=voiceToTextService.vtot(audioFile);
